{{/*
  ...
  {{ include "gitlab.scripts.configure" (
            dict
                "required" "your required secrets dirs" // optional, default "kas redis shell gitaly registry rails-secrets gitlab-workhorse"
...
for secret in {{ default "kas shell gitaly registry rails-secrets gitlab-workhorse" $.required }} ; do
