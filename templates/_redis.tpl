...
{{-   else if and $.Values.global.redis.redisYmlOverrideSecrets (index $.Values.global.redis.redisYmlOverrideSecrets $.redisConfigName) (kindIs "map" (get (index $.Values.global.redis.redisYmlOverrideSecrets $.redisConfigName) "password"))  -}}
