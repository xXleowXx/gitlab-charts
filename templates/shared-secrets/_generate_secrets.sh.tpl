...
generate_secret_if_needed {{ template "gitlab.gitlab-runner.registrationToken.secret" . }} --from-literal=runner-token=$(gen_random 'a-zA-Z0-9' 64) --from-literal=runner-registration-token=""
