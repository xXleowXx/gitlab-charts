...
- `<gitlab-ap-secret>`: The Application secret, which you created in a previous step.
- `<gitlab-app-id>`: The Application ID, which you created in a previous step.
...
If you have any trouble installing Mattermost Team Edition in GitLab Helm Chart deployment, let us know in our [Troubleshooting forum](http://www.mattermost.org/troubleshoot/) and Mattermost will be happy to help.