...
When you have successfully authenticated and connected to your GitLab instance, the next step is to integrate the two charts. The steps in 
this document presume in-chart MinIO instance usage. For information about out-of-chart object storage configuration, 
...
- `<your-mattermost-domain>`: URL that users will use to access Mattermost, matching the [Site URL field](https://docs.mattermost.com/administration/config-settings.html#site-url), e.g. `mattermost.gitlab.example.com`.
