...
[`cosign`](https://github.com/sigstore/cosign). These digests can be verified
using `cosign verify` command as described below:

NOTE:
Right now, the images are signed using a private key and can be only verified
...
1. Verify the CNG image using cosign
