...
The `task-runner` pod [was renamed](https://gitlab.com/gitlab-org/charts/gitlab/-/merge_requests/2099/diffs) to `toolbox` in `5.2.0` so any configuration that references `task-runner` will have to be renamed to `toolbox` as of `5.5.0`.
