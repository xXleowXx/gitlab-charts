...
Otherwise follow the [Google DNS quickstart guide](https://cloud.google.com/dns/docs/quickstart)
to create an empty Cloud DNS zone. The zone will be populated with DNS records in the next steps.
