...
Skip components by using the `--skip` argument. Valid components names can be found at [Command line arguments](../architecture/backup-restore.md#command-line-arguments).
