...
As part of the `5.0.0` release of this chart, we upgraded the PostgreSQL version from `11.7` to `12.7`. This is not a
...
You will need to remove any Unicorn configuration from you values before upgrading to the newest version.
