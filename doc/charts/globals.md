...
| `clientCertKeyPairs`            | String    |                            | GitLab client certificate key pairs utilized for mutual TLS authentication with GitLab API. |
| `caCerts`                       | String    |                            | Root CA certificates utilized for signing GitLab client certificates |
