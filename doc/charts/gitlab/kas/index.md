...
| `redis.clusterConfig`       | `sharedState`  | The Redis cluster configuration to pull from `global.redis` to use for KAS. If unset it defaults Redis cluster `sharedState` |
