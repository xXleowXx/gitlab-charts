...
| `statefulset.startupProbe.initialDelaySeconds`   | 5                                                | Delay before startup probe is initiated                                                                                                                                      |
| `statefulset.startupProbe.periodSeconds`         | 1                                                | How often to perform the startup probe                                                                                                                                       |
| `statefulset.startupProbe.timeoutSeconds`        | 3                                                 | When the startup probe times out                                                                                                                                             |
