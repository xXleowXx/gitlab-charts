...
| `workhorse.continuousProfiling` |  | A configuration string to enable [GitLab Continuous Profiling](https://gitlab.com/gitlab-org/labkit/-/blob/master/monitoring/doc.go) support. |
