...
| `service.ipFamilies`                            |                                                                                                                                                                             | The [IP family to use](https://kubernetes.io/docs/concepts/services-networking/dual-stack/#services) for single stack or IP families for dual-stack (Kubernetes 1.20+)                             |
| `service.ipFamilyPolicy`                        |                                                                                                                                                                             | The [IP stack selection](https://kubernetes.io/docs/concepts/services-networking/dual-stack/#services) requested or required by this Service (Kubernetes 1.20+)                                    |
