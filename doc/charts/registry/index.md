...
| `middleware.storage` |  | configuration layer for midleware storage ([s3 for instance](https://docs.docker.com/registry/storage-drivers/s3/#configuring-cloudfront-for-distribution))
...
Configuration of `middleware.storage` follows [upstream convention](https://docs.docker.com/registry/storage-drivers/s3/#registry-configuration):
...
```yaml
middleware:
  # See https://docs.docker.com/registry/configuration/#middleware
  storage: 
    - name: cloudfront
      options:
        baseurl: https://abcdefghijklmn.cloudfront.net/
...
`privatekey` used upstream is being auto-generated by chart and will be **ignored** if specified. 
