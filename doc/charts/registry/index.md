...
| `migration.importtimeout`                | `10m`                                      | The maximum duration that an import job may take to complete before it is aborted. This is an experimental feature and must not be used in production environments. |
