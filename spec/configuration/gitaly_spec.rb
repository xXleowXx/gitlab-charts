  ...
  context 'When customer provides additional labels' do
    ...
    context 'with only gitaly' do
      it 'Populates the additional labels in the expected manner' do
        ...
        expect(t.dig('StatefulSet/test-gitaly', 'spec', 'volumeClaimTemplates', 0, 'metadata', 'labels')).to include('global' => 'gitaly')
    ...
    context 'with praefect enabled' do
      ...
      it 'Populates the additional labels in the expected manner' do
        ...
        expect(t.dig('StatefulSet/test-gitaly-foo', 'spec', 'volumeClaimTemplates', 0, 'metadata', 'labels')).to include('global' => 'gitaly')
